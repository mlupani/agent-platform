...
Si pide confirmación por WhatsApp o dio teléfono, usá sendWhatsAppMessage para enviar la confirmación inmediata (no es un recordatorio programado; no prometas "te contacto antes del evento").
