...
export interface SocialProvider {
  ...
  replyToComment?(input: { postId: string; commentId: string; accountId: string; message: string }): Promise<void>;
  sendPrivateReplyToComment?(input: { postId: string; commentId: string; accountId: string; message: string }): Promise<void>;
}
