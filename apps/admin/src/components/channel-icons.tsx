...
/** Teléfono / llamada de voz */
export function VoiceChannelIcon({ className = 'h-5 w-5', title }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
    ...
    >
      {title ? <title>{title}</title> : null}
      <path d="M6.6 10.8c1.4 2.8 3.8 5.2 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.2.2 2.4.6 3.6.1.4 0 .8-.2 1l-2.3 2.2Z" />
    </svg>
  );
}
  ...
  if (value === 'VOICE') {
    return (
      <span
        ...
        className={`inline-flex ${box} items-center justify-center rounded-full bg-accent text-white shrink-0`}
      >
        <VoiceChannelIcon className={icon} title="Llamada" />
      </span>
    );
  }
